<div>
    <h1 class="text-4xl py-7 font-bold px-8">Atualizar Foto do Perfil</h1>
    <form wire:submit.prevent="storagePhoto" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-8 m-8">
        ...
        <button type="submit" class="bg-green-500 hover:bg-green-400 text-white p-2 pl-6 pr-6 rounded">Upload Foto</button>
    </form>
</div>